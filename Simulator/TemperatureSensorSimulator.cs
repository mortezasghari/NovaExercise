...
public class TemperatureSensorSimulator(Guid id, double initialTemperature, Random? random = null)
    : StageDrivenSensorSimulator(id, SensorType.Temperature, DefaultModel, initialTemperature, random)
{
